...
public class XmlUtils {
	...
	public static void writeEntryUrls(List<String> urlArray){
		...
		try{
			Document doc = sr.read(new File(rootPath +"/src/main/java/main/resources/entry-config.xml"));
	        ...
	        FileOutputStream out =new FileOutputStream(new File(rootPath + "/src/main/java/main/resources/entry-config.xml"));
	        // 指定文本的写出的格式：
